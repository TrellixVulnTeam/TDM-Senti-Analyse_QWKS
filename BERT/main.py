...
parser = argparse.ArgumentParser(description='Bert-Weibo-Senti-Classification')
...
if __name__ == '__main__':
    ...
    # train.train(config, model, train_iter, dev_iter, test_iter)   # 无需训练时可注释
    ...
    # 模型测试
    test.test(config, model, test_iter)     # 无需测试时可注释
